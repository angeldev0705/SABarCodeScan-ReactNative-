      ...
      >
        <View
          ...
          <View
            ...
            <View style={{
              width: 65,
              height: 65, borderRadius: 75 / 2,
              backgroundColor: iconbackgroundcolor,
              alignSelf: 'center', bottom: 40, justifyContent: 'center', alignItems: 'center', borderWidth: 2, borderColor: colors.COLOR_WHITE
            }}>
              <Image source={
                imagesource
              }
          ...
          {  subtitle == ConstantValues.NEW_MESSAGE_STR ?
            ...
            {(message == ConstantValues.SEND_RESPONSE_STR && subtitle != ConstantValues.NEW_MESSAGE_STR )?
              <TouchableOpacity
                style={{
                  justifyContent: 'center',
                  alignItems: 'center',
            ...
            <TouchableOpacity
              style={{
                justifyContent: 'center',
                alignItems: 'center',
                backgroundColor: maintitle == ConstantValues.VISITOR_ARRAIVAL_STR ? colors.COLOR_DARK_RED : iconbackgroundcolor,
                borderRadius: 30,
                marginVertical: 10,
                paddingVertical: paddingProps.tosm,
                paddingHorizontal: paddingProps.lg,
